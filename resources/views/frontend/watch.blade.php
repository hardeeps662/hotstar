           ...
           <div class="row p-2 d-flex justify-content-center flex-wrap ">
             <div class="p-3">
                 ...
                 <video width="1000" height="500" controls>
                   <source src="{{'/storage/videos/'.$videos->video}}" type="video/mp4">
                 </video>
                 <div class=" mt-3"><h4 class="font-weight-bold">{{$videos->name}}</h4></div>
                 <div class="mb-1"><span style="color: blue">{{$videos->tag}}</span></div>
                 <div class=""><p style="color: black" >{{$videos->details}}</p></div>
