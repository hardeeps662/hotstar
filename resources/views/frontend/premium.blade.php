...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-md-8">
			...
			<div class="col-md-6 offset-md-3">
				<a href="{{url('/subscribe/monthly')}}">
				<div class="breadcrumb" style="background-color: #eaf3fd;padding: .4rem 1rem;box-shadow: 1px 3px 5px #888888;">
					<div class="">
					<i class="fa fa-rupee"></i>
						<span style="font-size: 30px;text-align: left;color: #212121;margin-left: 1px;line-height: normal;">299</span><span style="margin-top: 9px">/Year</span>
