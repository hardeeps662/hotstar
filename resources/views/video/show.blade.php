            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/video/' . $video->id . '/edit') }}" title="Edit Video"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $video->name }} </td></tr><tr><th> Details </th><td> {{ $video->details }} </td></tr><tr><th> Tag </th><td> {{ $video->tag }} </td></tr>
                                </tbody>
                            </table>
                        </div>
